...
@Component({
  selector: 'header-sugestoes',
  templateUrl: './header-sugestoes.component.html',
  styleUrls: ['./header-sugestoes.component.scss']
})
export class HeaderSugestoesComponent implements OnInit {
